...
import "./interfaces/IMonoswapV3Factory.sol";
...
contract MonoswapV3Pool is IMonoswapV3Pool, NoDelegateCall {
    ...
    /// @dev Prevents calling a function from anyone except the address returned by IMonoswapV3Factory#owner()
    modifier onlyFactoryOwner() {
        require(msg.sender == IMonoswapV3Factory(factory).owner());
        _;
    }
